...
**Voice-over Comp**:
The After Effects composition that contains the voice-over source layer and receives generated subtitle text layers.
_Avoid_: timeline, sequence, Premiere sequence

**Voice-over Layer**:
A layer inside the Voice-over Comp whose source points to an imported audio or video file.
...
Developer: "When the user clicks Generate Subtitle, should we transcribe the Voice-over Comp or the Source Audio File?"
